...
# ==========================================
# 2. LOAD RAW DATA (Corrected for 2D CNNs)
# ==========================================
#eeg_data_path = '/kaggle/input/preprocessed-right/preprocessed_eeg_data_3D_psd (2).npz'
...
# CRITICAL FIX: Ensure data is 4D (N, 8, 8, 640) for the Conv2D Finder & U-Net
# If your data is somehow 5D (N, 8, 8, 640, 1), we squeeze it back to 4D
...
# input_shape_raw_eeg will now correctly be (8, 8, 640)
...
# ==========================================
# 3. REPLICATE THE EXACT 5-FOLD SPLIT
# ==========================================
...
# ==========================================
# 4. MODEL DEFINITIONS & HELPERS
# ==========================================
# (Insert your build_finder_cnn and build_simple_unet functions here)
...
def extract_unet_heatmaps(model, X_data, batch_size=64):
    ...
    # Target the last multi-filter conv layer dynamically
...
# ---> CHANGE THESE PATHS to wherever you saved your fold models!
finder_model_path = f'/kaggle/input/models/tshrds2663/finder-unet/tensorflow2/default/1/finder_fold_{TARGET_FOLD}.keras'
unet_model_path = f'/kaggle/input/models/tshrds2663/finder-unet/tensorflow2/default/1/unet_fold_{TARGET_FOLD}.keras'
...
# Evaluate Finder Test Accuracy just to verify it loaded correctly
...
# ==========================================
# 6. GENERATE FINDER MASKS (For Visualization / Ablation)
# ==========================================
print("\n--- Generating Finder Target Masks ---")
# To toggle between methods, just change this function call:
# -> use generate_dynamic_masks(finder_model, ...) for Grad-CAM
# -> use generate_dynamic_masks_score(finder_model, ...) for Score-CAM
...
# ==========================================
# 7. EXTRACT FINAL XaF HEATMAPS FROM U-NET
# ==========================================
print("\n--- Extracting Final XaF Heatmaps ---")
# IMPORTANT: As we discovered earlier, Score-CAM crashes on 8x8x1 segmentation outputs.
# ALWAYS use extract_unet_heatmaps (Grad-CAM) for the U-Net extraction step!
...
# Evaluate the Final XaF Continuous Heatmaps
...
# You can also evaluate the Finder's binary masks to see how the thresholding behaved
#_, hoyer_finder_mask = evaluate_hoyer_sparsity(y_mask_train, name="Finder Target Masks (Binary)")
# ==========================================
...
# ==========================================
# 9. SAVE FOLD DATA TO DISK (Or feed directly to ML Cell)
# ==========================================
